  ...
  try {
    ...
    queries.push(
      await database.query(
        ...
        VALUES("Abris-côtier", "Aquarelle", 2022, "800x600", "/assets/images/shelterWithFrame.png", "Paysage de la côte réunionnaise pendant l'été 2021", 7),
              ("Piton de la fournaise", "Dessin", 2023, "1024x1024", "/assets/images/PeakWithFrame.png", "Paysage du piton de la fournaise", 2),
              ("Le rougail saucisse local", "Aquarelle", 2023, "1024x1024", "/assets/images/rougailWithFrame.png", "Le plat traditionnel réunionnais par excellence", 1),
              ...
              ("Village de la Réunion", "Dessin", 2023, "1024x1024", "/assets/images/villageWithFrame.png", "Une journée classique dans un village de la Réunion", 8),
              ...
              ("L'ile de la Réunion", "Aquarelle", 2023, "1024x1024", "/assets/images/fusionColorWithFrame.png", "L'ile de la Réunion avec de fortes nuances roses et bleues", 5),
              ("L'ile de la Réunion", "Aquarelle", 2023, "1024x1024", "/assets/images/playaWithFrame.png", "Plage de l'ile de la Réunion", 6),
              ("L'ile de la Réunion", "Aquarelle", 2023, "1024x1024", "/assets/images/blueWithFrame.png", "L'ile de la Réunion avec de fortes nuances bleues", 8),
              ("L'ile de la Réunion", "Aquarelle", 2023, "1024x1024", "/assets/images/pinkVillage.png", "L'ile de la Réunion avec de fortes nuances roses", 2),
              ("Rougail-Saucisses", "Aquarelle", 2023, "1024x1024", "/assets/images/roseVillageWithFrame.png", "L'ile de la Réunion avec de fortes nuances roses", 1),
              ("Réunion", "Aquarelle", 2020, "1024x1024", "/assets/images/Reunion.jpg", "Aquarelle 'Reunion' par Pablo Picassiettes", 2),
              ("Le Piton", "Dessin", 2004, "1282 x 852", "/assets/images/Piton.png", "Dessin 'Le Piton' par Auguste Reblanc", 5)`
      )
    );
