    ...
    queries.push(
      await database.query(
        `INSERT INTO artist (biography, user_id)
            VALUES("Les personnages de Salvador Dall-E émergent de mondes oniriques. Leurs formes étranges et distordues invitent à une réflexion profonde sur la réalité et l'illusion, créant une expérience visuelle étrange et fascinante.", 1), 
            ("Pionnier de l'art numérique, il explore les frontières entre la réalité et la technologie. Ses toiles ne sont pas seulement des œuvres statiques, mais des portails interactifs vers des mondes virtuels, où l'art devient une expérience immersive et futuriste.", 2), 
            ("Née au cœur des montagnes andalouses, Frida Khaloops a grandi entourée de la splendeur naturelle qui a façonné son œuvre artistique. Les vallées luxuriantes, les rivières cristallines et les ciels incandescents ont nourri son âme artistique dès son plus jeune âge. Inspirée par la nature en perpétuel changement, Frida utilise une palette de couleurs dynamique pour capturer l'énergie vivante de la terre, faisant de chacune de ses toiles une célébration de la vie.", 3), 
            ("Issu des ruelles labyrinthiques de Brooklyn, Claude Monnaie incarne l'esprit urbain rebelle. Sa jeunesse au sein de cette jungle de béton l'a amené à voir l'art là où d'autres ne voyaient que la monotonie. En explorant des formes d'expression alternatives, Claude a élevé le graffiti au rang d'art, insufflant une magie visuelle dans des espaces souvent ignorés.", 4), 
            ("Auguste Reblanc, maître du réalisme, capture la vie quotidienne avec une précision frappante. Ses personnages sont comme des acteurs capturés sur une scène naturelle, offrant une profondeur narrative remarquable.", 5), 
            ("Élevée dans une petite ville où les contes de fées prenaient vie, Marc Chacaille a transformé son amour pour les récits fantastiques en une carrière artistique. Les pages des livres étaient ses fenêtres vers des mondes imaginaires, et aujourd'hui, ses illustrations magiques transportent les observateurs dans des royaumes où la réalité et la fantaisie se mêlent harmonieusement.", 6), 
            ("Eugène Delabière, maître de la lumière, façonne des personnages baignés dans une aura mystique. Ses œuvres captivent par l''utilisation judicieuse de la lumière et de l''ombre, ajoutant une dimension presque magique.", 7), 
            ("Gustave Klimteastwood fusionne l'art nouveau et le symbolisme, présentant des personnages ornés de motifs floraux et de formes sensuelles. Ses œuvres évoquent une élégance mystérieuse, chaque personnage étant une énigme visuelle à déchiffrer.", 8)`
      )
    );
